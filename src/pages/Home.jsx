...
export default function Home() {
  ...
  return (
    <div className='min-h-screen bg-[#EBEBE6] dark:bg-[#292927]  text-black dark:text-white'>
      ...
      <div className='min-h-screen w-[80%] mx-auto' >
        <h1 className='flex items-center gap-5 text-xl md:text-4xl p-4 mb-5 mt-20'> <hr className="w-[45%] md:w-[5%] border-black dark:border-white" /> Clubs <hr className="w-[45%] md:w-[80%] border-black dark:border-white " /> </h1>
